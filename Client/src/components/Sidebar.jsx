...
import { Avatar, Box, Text, Button, VStack, Divider, useToast,  } from "@chakra-ui/react";
...
const Sidebar = () => {
    ...
    const ShowSingup = useSelector(state=> state.signupPage.isSignInComponent)
    ...
    const handleLogout = async()=>{
        try {
            ...
            toast({
                ...
                description:"Due to some technical issue we are not able to log you out! SORRY for the trouble",
                status:'error',
                duration:5000,
                isClosable:true
            })
        ...
        >
           {ShowLogin && (
            ...
            <Box
                ...
                zIndex={98} 
            />
            <Box position="fixed" zIndex={99} top={'50%'} left={'50%'} transform={'translate(-50%,-50%)'}>
                <Login />
            </Box>
        </>
           )}
